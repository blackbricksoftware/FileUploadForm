...
class FUFSimpleImage extends SimpleImage {
	...
	public function resizeToFit($width, $height) {
		...
		// if we only have one, resize to that
		if (!$width) {
		...
		// if we have both, compare rations
	...
	public function quickSave($name) {

		$this->save($name,$this->image_type,100);
	}

	// resize with transparency support
